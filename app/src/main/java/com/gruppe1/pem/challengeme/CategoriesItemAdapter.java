 ...
 */
public class CategoriesItemAdapter extends  RecyclerView.Adapter<CategoriesItemAdapter.ViewHolder> implements View.OnClickListener,
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mImageView = (ImageView) v.findViewById(R.id.categoryImageView);
        }
    }

    public CategoriesItemAdapter(Context context, List<ListItemIconName> myDataset, boolean isViewAsList)
    {
    ...
    @Override
    public CategoriesItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = null;
        // create a new view
        if(isViewAsList) {
            v = LayoutInflater.from(context).inflate(R.layout.list_item_categories, parent, false);
        } else {
            v = LayoutInflater.from(context).inflate(R.layout.grid_item_categories, parent, false);
        }
        // TODO: set the view's size, margins, paddings and layout parameters

        ViewHolder vh = new ViewHolder(v);
        vh.mView.setOnClickListener(CategoriesItemAdapter.this);
        vh.mView.setOnLongClickListener(CategoriesItemAdapter.this);
        vh.mView.setTag(vh);
        return vh;
    }
