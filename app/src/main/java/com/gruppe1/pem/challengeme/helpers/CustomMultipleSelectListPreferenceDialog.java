...
public class CustomMultipleSelectListPreferenceDialog extends MultiSelectListPreference {

   private TextView headline;

   public CustomMultipleSelectListPreferenceDialog(Context context, AttributeSet attrs) {
      super(context, attrs);
   }
